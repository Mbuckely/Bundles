...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-white text-[#26130F]">
      ...
      {/* Contact form */}
<section className="flex justify-center px-5 py-14 sm:px-8 sm:py-20 lg:px-12">
  <div className="mx-auto w-full max-w-[620px]">
    <header className="mb-10 text-center">
      <h2 className="mx-auto max-w-[560px] text-3xl font-normal leading-tight tracking-[-0.03em] text-black sm:text-4xl">
        Have a question? We are happy to help.
      </h2>

      <p className="mx-auto mt-4 max-w-[500px] text-sm leading-7 text-[#26130F]/65">
    ...
    <form
      ...
      className="mx-auto w-full max-w-[520px] space-y-7"
    ...
    >
      ...
      <div>
        ...
        <div className="mt-2 grid grid-cols-[95px_1fr] gap-3 border-b border-[#26130F]/55 pb-4">
      ...
      <label className="block">
        ...
        <textarea
          className="mt-3 min-h-32 w-full resize-y border-0 border-b border-[#26130F]/55 bg-transparent px-0 py-3 text-base leading-7 text-[#26130F] outline-none transition focus:border-[#24651D] focus:ring-0"
          name="message"
          required
        />
      </label>
      ...
      <div className="!mt-8 flex w-full justify-center">
        <button
          ...
          className="contact-submit border-none bg-transparent p-0 text-sm font-medium text-[#26130F] shadow-none outline-none transition hover:text-[#FFB000] focus:outline-none focus:ring-0 disabled:cursor-not-allowed disabled:opacity-60"
        >
